...
export default function HUD({ title="HUD", extra }) {
  const { ballast, posRef, stageText } = useSim();
  const p = posRef.current;
  return (
    <div style={{position:"absolute",top:20,left:20,zIndex:10,color:"#fff",fontFamily:"monospace",background:"rgba(0,0,0,0.5)",padding:"10px 14px",borderRadius:10,minWidth:260}}>
